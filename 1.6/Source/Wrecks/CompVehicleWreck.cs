...
namespace VanillaVehiclesExpanded
{
  ...
  public class CompVehicleWreck : ThingComp
  {
    ...
    {
      var restoreWrecksDesignation =
        parent.Map.designationManager.DesignationOn(parent, VVE_DefOf.VVE_RestoreWreck);
    ...
    public void RestoreWreck(Pawn worker)
    {
      ...
      GenSpawn.Spawn(frame, GetMatchingPos(existingRect, pos, rot, vehicleDef), map, rot,
        WipeMode.VanishOrMoveAside);
      GameComponent_VehicleUseTracker.Instance.frameWrecks[frame] = this.parent.def;
    }

    public static IntVec3 GetMatchingPos(CellRect existingRect, IntVec3 cell, Rot4 rot,
      ThingDef vehicle)
    {

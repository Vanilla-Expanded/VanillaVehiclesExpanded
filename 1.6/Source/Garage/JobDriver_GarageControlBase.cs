...
namespace VanillaVehiclesExpanded
{
  ...
  public class JobDriver_OpenGarage : JobDriver_GarageControlBase
  {
    ...
    {
      return base.Map.designationManager.DesignationOn(base.TargetThingA, VVE_DefOf.VVE_Open) is
        null;
    }
  }
  ...
  public class JobDriver_CloseGarage : JobDriver_GarageControlBase
  {
    ...
    public override bool FailCondition()
    {
      return base.Map.designationManager.DesignationOn(base.TargetThingA, VVE_DefOf.VVE_Close) is
        null;
    }
  }
}
...
namespace VanillaVehiclesExpanded
{
  public class GameComponent_VehicleUseTracker : GameComponent
  {
    ...
    public override void ExposeData()
    {
      ...
      Scribe_Collections.Look(ref colonist_landvehicle_tracker_backup,
        "colonist_landvehicle_tracker_backup", LookMode.Reference, LookMode.Value, ref list2,
        ref list3);
      Scribe_Collections.Look(ref colonist_airvehicle_tracker_backup,
        "colonist_airvehicle_tracker_backup", LookMode.Reference, LookMode.Value, ref list4,
        ref list5);
      Scribe_Collections.Look(ref colonist_seavehicle_tracker_backup,
        "colonist_seavehicle_tracker_backup", LookMode.Reference, LookMode.Value, ref list6,
        ref list7);
      Scribe_Collections.Look(ref restoredWrecks, "restoredWrecks", LookMode.Def);
      Scribe_Collections.Look(ref frameWrecks, "frameWrecks", LookMode.Reference, LookMode.Def,
        ref frameKeys, ref thingDefValues);
    ...
    public override void GameComponentTick()
    {
      ...
      {
        if (Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf
         .VVE_Driving_Required) != null)
        {

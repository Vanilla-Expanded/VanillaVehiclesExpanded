...
namespace VanillaVehiclesExpanded
{
    public class CompReloadableWithVerbs : ThingComp, IVerbOwner, IReloadableComp, ICompWithCharges
    {
        ...
        {
            var comps = this.parent.comps.OfType<CompReloadableWithVerbs>().ToList();
        ...
        public void ReloadFrom(Thing ammo)
        {
            ...
            else
            {
                ...
                int num = Mathf.Clamp(ammo.stackCount / Props.ammoCountPerCharge, 0, this.MaxCharges - this.RemainingCharges);
